...
contact=Contato
contact.header=Diga "Ola!", sempre bom receber uma mensagem agradavel!
...
blog.post.view=Let's View
blog.comment=Comments
blog.comment.short=com.
blog.post.view=Let's View
blog.post.share=Share this post:

share.page=Share This Page

portfolio.images=Project Images 
